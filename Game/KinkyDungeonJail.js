		...
		if (!wearingLeash) {
			...
			if (playerDist > pullDist && KinkyDungeonSlowLevel < 2 && KinkyDungeonCheckProjectileClearance(KinkyDungeonPlayerEntity.x, KinkyDungeonPlayerEntity.y, KinkyDungeonJailGuard().x, KinkyDungeonJailGuard().y)) {
				...
				if (KinkyDungeonLastAction == "Move") {
					...
					KinkyDungeonSendDialogue(KinkyDungeonJailGuard(), msg, "#ffff00", 6, 7 + KinkyDungeonJailGuard().KinkyDungeonJailTourInfractions);
...
let KDCustomDefeatUniforms = {
	...
	CyberDoll: () => {
		...
		KinkyDungeonAddRestraintIfWeaker("CyberBallGag", 5, true, "Red", false, undefined, undefined, "Dollsmith", true);
		...
		KinkyDungeonAddRestraintIfWeaker("CyberDollJacket", 1, true, "White", false, undefined, undefined, "Dollsmith", true);
